...
namespace HotelBooking
{
    ...
    {
        private string CONNECTION_STRING = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\UOV\Year 2\VP\HotelDatabase.mdf;Integrated Security=True;Connect Timeout=30;Integrated Security=True;Connect Timeout=30";
        ...
        private void buttonInsert_Click(object sender, EventArgs e)
        {
            ...
            customer_name = textBoxCustName.Text.ToString();
            customer_identityNo = textBoxCustIdNo.Text.ToString();
            customerPhoneNo = textBoxCustPhoneNo.Text.ToString();
            ...
            else
            {
                ...
                cmd.CommandText = "INSERT INTO customer_table(customerName, email,phoneNo,idNo) VALUES('" + customer_name + "','" + customerEmail + "','" + customerPhoneNo + "','" + customer_identityNo + "')";
                cmd.Connection = conn;
