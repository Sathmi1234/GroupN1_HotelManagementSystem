...
namespace HotelBooking
{
    ...
    {
        private string CONNECTION_STRING = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Databases\HotelDatabase.mdf;Integrated Security = True; Connect Timeout = 30";
        public Login()
        {
            InitializeComponent();
        }
